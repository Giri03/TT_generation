from data import subjects, days, meettime, rooms, labs, years, teachers,divs
...
def tournament(population):
    ...
    newpop_lab_size = len(population[1]) // 3
    # some max no.
    cross = []
    # algo
    # iterate 200 time
